...
$PHPTHUMB_CONFIG['document_root'] = BASEPATH;
...
$PHPTHUMB_CONFIG['cache_directory'] = BASEPATH . 'bright/cache/';                             // set the cache directory relative to the phpThumb() installation
...
$PHPTHUMB_CONFIG['cache_maxfiles'] = 300;             // delete least-recently-accessed cached thumbnails when more than [200] cached files are present (value is maximum number of cached files to keep)
...
$PHPTHUMB_CONFIG['error_message_image_default'] = (PHPTHUMBERRORIMAGE != '' && PHPTHUMBERRORIMAGE != null) ? PHPTHUMBERRORIMAGE : '/bright/library/phpThumb/notfound.png';       // Set this to the name of a generic error image (e.g. '/images/error.png') that you want displayed in place of any error message that may occur. This setting is overridden by the 'err' parameter, which does the same thing.
if(!LIVESERVER) {
	$PHPTHUMB_CONFIG['error_message_image_default'] = null;
}
$PHPTHUMB_CONFIG['error_bgcolor']               = 'F1F1F1'; // background color of error message images
$PHPTHUMB_CONFIG['error_textcolor']             = '000000'; // color of text in error messages
$PHPTHUMB_CONFIG['error_fontsize']              = 2;        // size of text in error messages, from 1 (smallest) to 5 (largest)
