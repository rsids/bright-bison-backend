 ...
 /* o------------------------------------------------------------------------------o
   ...
   *  Adapted for Sphider-plus application by Rolf Kellner [Tec] Feb. 2010
    ...
    * o------------------------------------------------------------------------------o */
    ...
    class it_stemmer {
        private $vocali = array('a','e','i','o','u','à','è','ì','ò','ù');
        private $consonanti = array('b','c','d','f','g','h','j','k','l','m','n','p','q','r','s','t','v','w','x','y','z','I','U');
        private $accenti_acuti = array('á','é','í','ó','ú');
        private $accenti_gravi = array('à','è','ì','ò','ù');
        ...
        private $suffissi_step_1_a = array('anza','anze','ico','ici','ica','ice','iche','ichi','ismo','ismi','abile','abili','ibile','ibili','ista','iste','isti','istà','istè','istì','oso','osi','osa','ose','mente','atrice','atrici','ante','anti');
        ...
        private $suffissi_step_1_h = array('ità');
