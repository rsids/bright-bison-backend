...
/* o------------------------------------------------------------------------------o
    ...
    * o------------------------------------------------------------------------------o */
    ...
    define('fr_pattern', '/^[a-zA-ZÃ¢Ã Ã¡Ã©Ã¨ÃªÃ«Ã®Ã¯Ã´Ã¶Ã¹Ã»Ã¼Ã§Ã‚Ã€Ã‰ÃˆÃŠÃ‹ÃŽÃÃ”Ã–Ã™Ã›ÃœÃ‡\']+$/');
    ...
    class fr_stemmer{
        ...
        function frenchstemmer_clean_word($word) {
            ...
            $pattern[]='/[cC]([kaouKAOUÃ¢Ã Ã¡Ã´Ã¶Ã¹Ã»Ã¼Ã‚Ã€Ã”Ã–Ã™Ã›Ãœ])/u';
            $replace[]='k\\1';
            $pattern[]='/([aeiouAEIOUÃ¢Ã Ã¡Ã©Ã¨ÃªÃ«Ã®Ã¯Ã´Ã¶Ã¹Ã»Ã¼Ã‚Ã€Ã‰ÃˆÃŠÃ‹ÃŽÃÃ”Ã–Ã™Ã›Ãœ])[sS]([aeiouAEIOUÃ¢Ã Ã¡Ã©Ã¨ÃªÃ«Ã®Ã¯Ã´Ã¶Ã¹Ã»Ã¼Ã‚Ã€Ã‰ÃˆÃŠÃ‹ÃŽÃÃ”Ã–Ã™Ã›Ãœ])/u';
            $replace[]='\\1z\\2';
            $pattern[]='/ss/';
            $replace[]='s';
            $pattern[]='/([sS]?)[cC]([eiEIÃ©Ã¨ÃªÃ«Ã®Ã¯Ã‰ÃˆÃŠÃ‹ÃŽÃ])/u';
            $replace[]='\\1s\\2';
            $pattern[]='/c/';
            $replace[]='k';
            $pattern[]='/[kK][sS]/';
