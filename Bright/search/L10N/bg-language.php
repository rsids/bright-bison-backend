...
$sph_messages =  Array (
	"Categories" => "ÃŠÃ Ã²Ã¥Ã£Ã®Ã°Ã¨Ã¨",
	"CATEGORIES" => "ÃŠÃ€Ã’Ã…ÃƒÃŽÃÃˆÃˆ",
	"Untitled" => "ÃÃ¥Ã®Ã§Ã Ã£Ã«Ã Ã¢Ã¥Ã­Ã®",
	"Powered by" => "Powered by",
	"Previous" => "ÃÃ°Ã¥Ã¤Ã¨Ã¸Ã­Ã ",
	"Next" => "Ã‘Ã«Ã¥Ã¤Ã¢Ã Ã¹Ã ",
	"Result page" => "Ã‘Ã²Ã°Ã Ã­Ã¨Ã¶Ã  Ã± Ã°Ã¥Ã§Ã³Ã«Ã²Ã Ã²Ã¨",
	"Only in category" => "Ã‘Ã Ã¬Ã® Ã¢ ÃªÃ Ã²Ã¥Ã£Ã®Ã°Ã¨Ã¿Ã²Ã ",
	"Search" => "Ã’ÃºÃ°Ã±Ã¥Ã­Ã¥",
	"All sites" => "Ã‚Ã±Ã¨Ã·ÃªÃ¨ Ã±Ã Ã©Ã²Ã®Ã¢Ã¥",
	"Web pages" => "Ã“Ã¥Ã¡ Ã±Ã²Ã°Ã Ã­Ã¨Ã¶Ã¨",
	"noMatch" => "ÃÃ°Ã¨ Ã²ÃºÃ°Ã±Ã¥Ã­Ã¥Ã²Ã® Ã§Ã  <strong>%query</strong> Ã­Ã¥ Ã¡Ã¿ÃµÃ  Ã­Ã Ã¬Ã¥Ã°Ã¥Ã­Ã¨ Ã°Ã¥Ã§Ã³Ã«Ã²Ã Ã²Ã¨.",
	"ignoredWords" => "Ã‘Ã«Ã¥Ã¤Ã­Ã¨Ã²Ã¥ Ã¤Ã³Ã¬Ã¨ Ã¡Ã¿ÃµÃ  Ã¨Ã£Ã­Ã®Ã°Ã¨Ã°Ã Ã­Ã¨, Ã§Ã Ã¹Ã®Ã²Ã® Ã±Ã  ÃªÃ°Ã Ã²ÃªÃ¨ Ã¨Ã«Ã¨ Ã·Ã¥Ã±Ã²Ã® Ã±Ã°Ã¥Ã¹Ã Ã­Ã¨: <strong>%ignored_words</strong>",
	"resultsFor" => "ÃÃ¥Ã§Ã³Ã«Ã²Ã Ã²Ã¨ Ã§Ã :",
	"Results" => "ÃÃ¥Ã§Ã³Ã«Ã²Ã Ã²Ã¨ %from - %to Ã®Ã² %all %matchword  (%secs Ã±Ã¥Ãª).", //
	"match" => "Ã±ÃºÃ¢Ã¯Ã Ã¤Ã¥Ã­Ã¨Ã¥",     //
	"matches" => "Ã±ÃºÃ¢Ã¯Ã Ã¤Ã¥Ã­Ã¨Ã¿", //
	"andSearch" => "Ã’ÃºÃ°Ã±Ã¥Ã­Ã¥ Ãˆ",
	"orSearch" => "Ã’ÃºÃ°Ã±Ã¥Ã­Ã¥ ÃˆÃ‹Ãˆ",
	"phraseSearch" => "Ã’ÃºÃ°Ã±Ã¥Ã­Ã¥ Ã­Ã  Ã²Ã®Ã·Ã­Ã Ã²Ã  Ã´Ã°Ã Ã§Ã ",
	"show" => "ÃÃ®ÃªÃ Ã¦Ã¨ ",
	"resultsPerPage" => "Ã°Ã¥Ã§Ã³Ã«Ã²Ã Ã²Ã  Ã­Ã  Ã±Ã²Ã°Ã Ã­Ã¨Ã¶Ã ",
    "DidYouMean" => "ÃŒÃ®Ã¦Ã¥ Ã¡Ã¨ Ã²ÃºÃ°Ã±Ã¨Ã²Ã¥",
