...
$sph_messages =  Array (
	...
	"Powered by" => "TÃ¡mogatja a",
	"Previous" => "ElÃµzÃµ",
	"Next" => "KÃ¶vetkezÃµ",
	"Result page" => "EredmÃ©nyek",
	"Only in category" => "Csak ebben a kategÃ³riÃ¡ban",
	"Search" => "KeresÃ©s",
	"All sites" => "Minden oldal",
	"Web pages" => "Weblapok",
	"noMatch" => "A keresÃ©snek \"%query\" nem volt eredmÃ©nye",
	"ignoredWords" => "A kÃ¶vetkezÃµ szavakat hagytam figyelmen kÃ­vÃ¼l (tÃºl rÃ¶vid vagy Ã¡ltalÃ¡nos): %ignored_words",
	"resultsFor" => "EredmÃ©nyek:",
	"Results" => "EredmÃ©nyek listÃ¡zÃ¡sa %from - %to ennyibÃµl: %all %matchword (%secs mp)", //
	"match" => "egyezÃ©s",     //
	"matches" => "egyezÃ©s", //
	"andSearch" => "Ã‰S keresÃ©s",
	"orSearch" => "VAGY keresÃ©s",
	"phraseSearch" => "KifejezÃ©s keresÃ©se",
	"show" => "Mutass ",
