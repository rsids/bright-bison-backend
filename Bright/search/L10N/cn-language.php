...
$sph_messages =  Array (
	"Categories" => "Ã€Ã Â±Ã°",
	"CATEGORIES" => "Ã€Ã Â±Ã°",
	"Untitled" => "ÃŽÂ´ÃƒÃ¼ÃƒÃ»",
	"Powered by" => "Powered by",
	"Previous" => "Ã‰ÃÃ’Â»Ã’Â³",
	"Next" => "ÃÃ‚Ã’Â»Ã’Â³",
	"Result page" => "Â½Ã¡Â¹Ã»Ã’Â³ÃƒÃ¦",
	"Only in category" => "Ã–Â»Ã”ÃšÃ€Ã Â±Ã°",
	"Search" => "Ã‹Ã‘Ã‹Ã·",
	"All sites" => "Ã‹Ã¹Ã“ÃÃ•Â¾ÂµÃ£",
	"Web pages" => "ÃÃ¸Ã’Â³",
	"noMatch" => "Ã‹Ã‘Ã‹Ã· \"%query\" ÃƒÂ»Ã“ÃÃˆÃŽÂºÃŽÃŽÃ„Â¼Ã¾Ã†Â¥Ã…Ã¤",
	"ignoredWords" => "Ã’Ã”ÃÃ‚Â´ÃŠÂ±Â»ÂºÃ¶Ã‚Ã”ÃÃ‹(ÃŒÂ«Â¶ÃŒ,Ã–ÃÃ‰Ã™3Ã—Ã–Â½ÃšÂ£Â¨Ã–ÃÃŽÃ„2Ã—Ã–Â£Â©): %ignored_words",
	"resultsFor" => "Â½Ã¡Â¹Ã»ÃŠÃ‡:",
	"Results" => "ÃÃ”ÃŠÂ¾Â½Ã¡Â¹Ã» %from - %to  Ã“Ã‰Ã“Ãš %all %matchword (%secs ÃƒÃ«)", //
	"match" => "Ã†Â¥Ã…Ã¤",     //
	"matches" => "Ã†Â¥Ã…Ã¤", //
	"andSearch" => "Ã“Ã«Ã‹Ã‘Ã‹Ã·",
	"orSearch" => "Â»Ã²Ã‹Ã‘Ã‹Ã·",
	"phraseSearch" => "Â´ÃŠÃ—Ã©Ã‹Ã‘Ã‹Ã·",
	"show" => "ÃÃ”ÃŠÂ¾ ",
	"resultsPerPage" => "ÃƒÂ¿Ã’Â³Â½Ã¡Â¹Ã»",
