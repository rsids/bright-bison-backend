...
######################################
$sph_messages =  Array (
	"Categories" => "ÃÃ“ÃŠÃ¥ ÃˆÃ¤ÃÃ­Ã¥Ã‡",
	"CATEGORIES" => "ÃÃ“ÃŠÃ¥ ÃˆÃ¤ÃÃ­Ã¥Ã‡",
	"Untitled" => "ÃˆÃÃ¦Ã¤ ÃšÃ¤Ã¦Ã‡Ã¤",
	"Powered by" => "Powered by",
	"Previous" => "ÃžÃˆÃ¡Ã­",
	"Next" => "ÃˆÃšÃÃ­",
	"Result page" => "ÃŠÃšÃÃ‡Ã Ã•ÃÃŽÃ‡ÃŠ Ã¤ÃŠÃ­ÃŒÃ¥",
	"Only in category" => "ÃÃžÃ˜ ÃÃ‘ ÃÃ“ÃŠÃ¥ ÃˆÃ¤ÃÃ­",
	"Search" => "ÃŒÃ“ÃŠÃŒÃ¦",
	"All sites" => "ÃŠÃ£Ã‡Ã£ Ã“Ã‡Ã­ÃŠÃ¥Ã‡",
	"Web pages" => "Ã•ÃÃÃ‡ÃŠ Ã¦Ãˆ",
	"noMatch" => "ÃšÃˆÃ‡Ã‘ÃŠ \"%query\" Ã¤ÃŠÃ­ÃŒÃ¥ Ã‡Ã­ ÃÃ‘ ÃˆÃ‘ Ã¤ÃÃ‡Ã”ÃŠ",
	"ignoredWords" => "ÃˆÃÃ¡Ã­Ã¡ ÃŸÃ¦ÃŠÃ‡Ã¥ ÃˆÃ¦ÃÃ¤ Ã¦ Ã­Ã‡ ÃšÃ£Ã¦Ã£Ã­ ÃˆÃ¦ÃÃ¤ Ã‡Ã’ ÃŸÃ¡Ã‡Ã£Ã‡ÃŠ Ã’Ã­Ã‘ Ã•Ã‘ÃÃ¥ Ã¤Ã™Ã‘ Ã”Ã: %ignored_words",
	"resultsFor" => "Ã¤ÃŠÃ­ÃŒÃ¥ ÃˆÃ‘Ã‡Ã­:",
	"Results" => "Ã¤Ã£Ã‡Ã­Ã” Ã¤ÃŠÃ­ÃŒÃ¥ %from ÃŠÃ‡ %to Ã‡Ã’ %all %matchword . Ã’Ã£Ã‡Ã¤ ÃŒÃ“ÃŠÃŒÃ¦: %secs Ã‹Ã‡Ã¤Ã­Ã¥", //
	"match" => "  ÃˆÃ‡Ã£Ã˜Ã‡ÃˆÃž",     //
	"matches" => "Ã£Ã¦Ã‘Ã", //
	"andSearch" => "ÃŒÃ“ÃŠÃŒÃ¦ ÃˆÃ‘ Ã‘Ã¦Ã­ ÃŠÃ£Ã‡Ã£ ÃŸÃ¡Ã‡Ã£Ã‡ÃŠ",
	"orSearch" => "ÃŒÃ“ÃŠÃŒÃ¦ ÃˆÃ‘ Ã‘Ã¦Ã­ Ã¥Ã‘ Ã­ÃŸ Ã‡Ã’ ÃŸÃ¡Ã£Ã‡ÃŠ",
	"phraseSearch" => "ÃŒÃ“ÃŠÃŒÃ¦Ã­ ÃšÃˆÃ‡Ã‘ÃŠ",
	"show" => "Ã¤Ã£Ã‡Ã­Ã”",
	"resultsPerPage" => "ÃŠÃšÃÃ‡Ã Ã¤ÃŠÃ­ÃŒÃ¥ ÃÃ‘ Ã•ÃÃÃ¥",
