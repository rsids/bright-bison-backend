...
$sph_messages =  Array (
	...
	"noMatch" => "PretraÅ¾ivanje \"%query\" nije rezultiralo pronaÃ°enim dokumentima",
	"ignoredWords" => "SlijedeÃ¦e rijeÃ¨i bile su ignorirane (prekratke ili uÃ¨estale): %ignored_words",
