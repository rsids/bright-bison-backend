...
$sph_messages =  Array (
	...
	"Search" => "Arama Yap",
	"All sites" => "BÃ¼tÃ¼n Siteler",
	"Web pages" => "Web SayfalarÃ½",
	"noMatch" => "Arama Sonucunda \"%query\" Konu Ãle Ãlgili Bir Dokuman BulunamamÃ½Ã¾tÃ½r.",
	"ignoredWords" => "Following words were ignored (too short or common): %ignored_words",
	"resultsFor" => "ÃÃ§in sonuÃ§lar:",
	"Results" => "Arama Sonucunda %from - %to ve %all %matchword (%secs seconds) ",
	"match" => "SonuÃ§",
	"matches" => "GÃ¶rÃ¼ntÃ¼lenmektedir.",
	"andSearch" => "ve arama yap",
	"orSearch" => "veya aramaya devam et",
	"phraseSearch" => "SÃ¶zcÃ¼k grubu arar",
	"show" => "GÃ¶ster ",
	"resultsPerPage" => "Sayfa BaÃ¾Ã½ olan SonuÃ§lar",
