...
$sph_messages =  Array (
	...
	"Previous" => "<",
	"Next" => ">",
	"Result page" => "LehekÃ¼lg",
	"Only in category" => "Ainult kategooriast",
	"Search" => "Otsi",
	"All sites" => "KÃµik lehed",
	"Web pages" => "VeebilehekÃ¼ljed",
	"noMatch" => "PÃ¤ringule \"%query\" ei vastanud Ã¼kski dokument",
	"resultsFor" => "Otsing:",
	"ignoredWords" => "JÃ¤rgnevaid sÃµnu ignoreeriti (liiga lÃ¼hikesed vÃµi Ã¼ldised): %ignored_words",
