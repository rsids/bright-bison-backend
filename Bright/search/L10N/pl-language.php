...
$sph_messages =  Array (
	...
	"noMatch" => "Â¯aden dokument nie pasowaÂ³ do zapytania \"%query\"",
	"ignoredWords" => "NastÃªpujÂ±ce sÂ³owa zostaÂ³y zignorowane: %ignored_words",
	"resultsFor" => "Wyniki wyszykiwania dla:",
	"Results" => "WyÂ¶wietlanie wynikÃ³w %from - %to z %all %matchword (%secs sekund)", //
	...
	"show" => "PokaÂ¿ ",
	"resultsPerPage" => "wynikÃ³w na stronie",
