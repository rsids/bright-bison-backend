...
$sph_messages =  Array (
	...
	"Powered by" => "",
	"Previous" => "IepriekÃ°Ã§jie",
	"Next" => "NÃ¢kamie",
	"Result page" => "MeklÃ§Ã°anas rezultÃ¢ti",
	"Only in category" => "Tikai sadaÃ¯Ã¢",
	"Search" => "MeklÃ§t",
	"All sites" => "Visos saitos",
	"Web pages" => "tÃ®mekÃ¯a lapas",
	"noMatch" => "MeklÃ§jot \"%query\", nekas netika atrasts",
	"ignoredWords" => "<p>SekojoÃ°i vÃ¢rdi netika izmantoti meklÃ§Ã°anÃ¢ (tie ir pÃ¢rÃ¢k Ã®si vai pÃ¢rÃ¢k izplatÃ®ti): %ignored_words</p>",
	"resultsFor" => "MeklÃ§Ã°anas rezultÃ¢ti:",
//	"Results" => "Displaying results %from - %to of %all %matchword (%secs seconds) ", //matchword will be replaced by match or matches (from this file), depending on the number of results.
	"Results" => "RezultÃ¢ti no %from lÃ®dz %to (kopÃ¢ %all %matchword) ", //matchword will be replaced by match or matches (from this file), depending on the number of results.
	"match" => "rezultÃ¢ts",
	"matches" => "rezultÃ¢ti",
	"andSearch" => "AND meklÃ§Ã°ana (koks UN ceÃ¯Ã°)",
	"orSearch" => "OR meklÃ§Ã°ana (koks VAI ceÃ¯Ã°)",
	"phraseSearch" => "MeklÃ§t frÃ¢zi",
	"show" => "ParÃ¢dÃ®t ",
	"resultsPerPage" => "rezultÃ¢tus vienÃ¢ lapÃ¢",
