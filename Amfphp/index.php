...
$servicesPath = BASEPATH . 'bright/library/Bright/services/';
include_once($servicesPath . 'objects/ObjectInitializer.php');
$cfg = new Amfphp_Core_Config();
$cfg -> serviceFolderPaths[] = $servicesPath;
$cfg -> checkArgumentCount = !LIVESERVER;
// $cfg -> sharedConfig[Amfphp_Core_Config::CONFIG_FORCE_AMF3] = true;
